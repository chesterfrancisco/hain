<div class="header-bottom sticky-bar" style="background-color: #945f2b">
    <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="position-static">
                                ...
                                &nbsp;
                                <a href="shop-grid-right.html">Deals 
                                    ...
                                    <li class="sub-mega-menu sub-mega-menu-width-34">
                                        <div class="menu-banner-wrap">
                                            <a href="shop-product-right.html">
                                                <img src="assets/imgs/banner/banner-menu.png" alt="Nest" /></a>
