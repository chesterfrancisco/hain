                ...
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            ...
                            <span>9.856</span>
                            <span class="text-sm"> In 10 Categories </span>
                        </div>
                    </article>
                </div>
            </div>
                                ...
                                <div class="new-member-list">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6>Carlos Camar</h6>
                                                <p class="text-muted font-xs">Laguna</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6>Chester Francisco</h6>
                                                <p class="text-muted font-xs">Manila</p>
                                            </div>
                                        </div>
                                        <a href="#" class="btn btn-xs"><i class="material-icons md-add"></i> Add</a>
                                    </div>
                                ...
                                <ul class="verti-timeline list-unstyled font-sm">
                                    ...
                                    <li class="event-list">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div>Responded to need “Activities</div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
            ...
            <header class="card-header">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 col-6">
                        <input type="date" value="02.05.2024" class="form-control" />
                    </div>
                    <div class="col-md-2 col-6">
                        <div class="custom_select">
                            <select class="form-select select-nice">
